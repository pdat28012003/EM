...
import { assignmentsAPI, authAPI, studentsAPI } from '../../../services/api';
...
const StudentAssignmentDetail = () => {
  ...
  const handleSubmit = useCallback(async (note) => {
    ...
    if (!content.trim()) {
      setError('Vui lòng nhập nội dung bài làm trước khi nộp.');
      return;
    }
  ...
  }, [studentId, numericAssignmentId, assignment, quizResult, questions, elapsedSeconds, content, navigate]);
