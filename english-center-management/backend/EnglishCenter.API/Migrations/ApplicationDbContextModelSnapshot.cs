            ...
            modelBuilder.Entity("EnglishCenter.API.Models.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoomId = 1,
                            Capacity = 20,
                            Description = "Ph�ng h?c ti�u chu?n 20 ch?",
                            IsActive = true,
                            RoomName = "Ph�ng 101"
                        },
                        new
                        {
                            RoomId = 2,
                            Capacity = 15,
                            Description = "Ph�ng h?c nh? 15 ch?",
                            IsActive = true,
                            RoomName = "Ph�ng 102"
                        });
                });
            ...
            modelBuilder.Entity("EnglishCenter.API.Models.Skill", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            SkillId = 2,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "K? nang n�i ti?ng Anh",
                            IsActive = true,
                            Name = "Speaking",
                            UpdatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
