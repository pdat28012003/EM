    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseEnrollments_Curriculums_CurriculumId",
                        column: x => x.CurriculumId,
                        principalTable: "Curriculums",
                        principalColumn: "CurriculumId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CurriculumSessions_Documents_DocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaymentCourseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PaymentId = table.Column<int>(type: "int", nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentCourses", x => x.PaymentCourseId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Curriculums",
                columns: new[] { "CurriculumId", "CreatedDate", "CurriculumName", "Description", "EndDate", "ModifiedDate", "StartDate", "Status" },
                values: new object[] { 1, new DateTime(2024, 2, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lớp tiếng Anh cơ bản A1", "Khóa học tiếng Anh cơ bản cho người mới bắt đầu", new DateTime(2024, 6, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Active" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Center Teacher", "Teacher" },
                    { 3, "Center Student", "Student" }
                });

            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "RoomId", "Capacity", "Description", "IsActive", "RoomName" },
                values: new object[,]
                {
                    { 1, 20, "Phòng học tiêu chuẩn 20 chỗ", true, "Phòng 101" },
                    { 2, 15, "Phòng học nhỏ 15 chỗ", true, "Phòng 102" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CurriculumCourseId", "CourseId", "CurriculumId", "OrderIndex" },
                values: new object[] { 1, 1, 1, 1 });

            migrationBuilder.InsertData(
                table: "Enrollments",
                columns: new[] { "EnrollmentId", "CurriculumId", "EnrollmentDate", "Status", "StudentId" },
                values: new object[,]
                {
                    ...
                    { 5, 1, new DateTime(2024, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Active", 14 }
                });

            migrationBuilder.InsertData(
                table: "Payments",
                columns: new[] { "PaymentId", "Amount", "Gateway", "Notes", "PaymentCompletedDate", "PaymentDate", "PaymentMethod", "QRCodeUrl", "Status", "StudentId", "TransactionId" },
                values: new object[,]
                {
                    { 1, 2000000m, null, "Full payment for English for Beginners course", null, new DateTime(2024, 2, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bank Transfer", null, "Completed", 1, null },
                    { 2, 2000000m, null, "Full payment for English for Beginners course", null, new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cash", null, "Completed", 2, null },
                    { 3, 2000000m, null, "Full payment for English for Beginners course", null, new DateTime(2024, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Credit Card", null, "Completed", 3, null },
                    { 4, 500000m, null, "Partial payment for additional materials", null, new DateTime(2024, 4, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bank Transfer", null, "Completed", 1, null },
                    { 5, 300000m, null, "Late fee payment", null, new DateTime(2024, 4, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cash", null, "Completed", 2, null }
                });

            migrationBuilder.InsertData(
                table: "TestScores",
                columns: new[] { "TestScoreId", "ClassId", "Comments", "CurriculumId", "ListeningScore", "ReadingScore", "SpeakingScore", "StudentId", "TestDate", "TestName", "TotalScore", "WritingScore" },
                values: new object[,]
                {
                    { 1, 1, "Good performance in listening and writing. Need more practice in speaking.", 0, 8.5m, 7.8m, 7.5m, 1, new DateTime(2024, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Midterm Exam - Unit 1", 8.0m, 8.2m },
                    { 2, null, "Excellent improvement in all skills. Keep up the good work!", 1, 9.0m, 8.5m, 8.2m, 1, new DateTime(2024, 4, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Final Exam - Unit 1", 8.6m, 8.8m },
                    { 3, null, "Average performance. Should focus more on listening comprehension.", 1, 6.5m, 7.0m, 7.2m, 2, new DateTime(2024, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Midterm Exam - Unit 1", 6.9m, 6.8m },
                    { 4, null, "Good understanding of grammar. Vocabulary needs improvement.", 1, 7.2m, 8.0m, 7.8m, 2, new DateTime(2024, 3, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Quiz - Grammar & Vocabulary", 7.6m, 7.5m },
                    { 5, 1, "Outstanding speaking skills! Very fluent and confident.", 0, 8.8m, 8.2m, 9.2m, 1, new DateTime(2024, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Quiz - Conversation Skills", 8.7m, 8.5m },
                    { 6, 1, "Below average performance. Requires additional support and practice.", 0, 5.5m, 6.0m, 6.2m, 3, new DateTime(2024, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Midterm Exam - Unit 1", 5.9m, 5.8m },
                    { 7, 1, "Writing has improved. Still needs work on basic grammar.", 0, 6.0m, 6.5m, 6.0m, 3, new DateTime(2024, 3, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Assignment - Writing Practice", 6.3m, 6.8m },
                    { 8, 1, "Consistent high performance. Ready for advanced level.", 0, 9.2m, 8.8m, 8.5m, 1, new DateTime(2024, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Final Exam - Unit 2", 8.9m, 9.0m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseEnrollments_CurriculumId",
                table: "CourseEnrollments",
                column: "CurriculumId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurriculumSessions_DocumentId",
                table: "CurriculumSessions",
                column: "DocumentId");
